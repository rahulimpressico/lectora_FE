...
const UPLOAD_FILE_STRIPE: Record<UploadedFile["status"], string> = {
  idle: "bg-slate-200",
  ...
  return (
    ...
    >
      <div className="flex items-center gap-0">
        <div className={cn("w-1 self-stretch shrink-0 transition-colors", UPLOAD_FILE_STRIPE[file.status])} />
        ...
        <div className="min-w-0 flex-1 py-2.5">
          <p className="truncate text-[13px] font-medium text-slate-700 leading-none">{file.name}</p>
        ...
        <div className="shrink-0 px-3">
          {isProcessing ? (
            ...
            <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Queued</span>
          )}
        </div>
