...
import { fadeUp, fadeIn, scaleIn, staggerContainer, miniCardStagger } from './constants/animations'
import { WELCOME_MINI_CARDS } from './constants/welcomeScreen'
    ...
    >
      ...
      <div className="min-h-full flex items-center justify-center px-4 py-16">
        ...
        >
          ...
          >
            {WELCOME_MINI_CARDS.map(({ icon: Icon, step, label }) => (
              <motion.div
                key={step}
