...
import { fadeUp, fadeIn, scaleIn, staggerContainer, cardEnter } from '../constants/animations'
import { getSections, getSectionTitle, getSectionMeta, capitalize, getSectionTopics } from '../utils/coursePreview'
