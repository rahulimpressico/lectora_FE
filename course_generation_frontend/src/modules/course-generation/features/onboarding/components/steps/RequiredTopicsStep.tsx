...
import { AlertCircle, BookOpen, Loader2, Pencil, RefreshCw, Sparkles, X } from 'lucide-react'
...
export const RequiredTopicsStep = () => {
  ...
  const generate = (replace: boolean) => {
    ...
    suggestRequiredTopics(buildRequestBody())
      .then((result) => {
  ...
  return (
    ...
    >
      ...
      {/* AI action row */}
      <motion.div className="flex items-center gap-2" variants={fadeUp} style={{ willChange: 'transform' }}>
        {requiredTopics.length > 0 ? (
          <motion.button
            type="button"
