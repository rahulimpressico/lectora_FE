...
const floodInsuranceStages: StageBreakdown[] = [
  ...
  {
    stageKey: 'outline_interpretation',
    stageName: 'Outline Interpretation',
  ...
  {
    stageKey: 'structure_review',
    stageName: 'Structure Review',
    inputTokens: 45_000,
    outputTokens: 8_000,
    cost: 0.345,
    requests: 12,
  ...
  {
    stageKey: 'kc_planning',
    stageName: 'KC Planning',
    inputTokens: 280_000,
    outputTokens: 95_000,
    cost: 0.099,
    requests: 18,
...
const floodInsuranceDoc: DocumentCost = {
  ...
  documentType: 'Course Generation',
  runSummary: 'Full course workflow: TO/classification, outline interpretation, then lesson content generation.',
  status: 'completed',
  totalCost: 8.202,
