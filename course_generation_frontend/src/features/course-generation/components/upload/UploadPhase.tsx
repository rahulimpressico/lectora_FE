  ...
  return (
    <div className="flex flex-col h-full bg-[#eceff8]">
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        <div className="mx-auto max-w-[1400px] px-6 sm:px-10 py-6">
          {/* Two-column grid — right column is sticky, left grows freely */}
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_380px] xl:grid-cols-[minmax(0,1fr)_420px] gap-5">
            ...
            <div className="rounded-2xl bg-white border border-slate-200/50 shadow-[0_2px_12px_-2px_rgb(0,0,0,0.08),0_8px_32px_-6px_rgb(0,0,0,0.05)] overflow-hidden">
              ...
              {/* Panel header */}
              <div className="px-7 pt-6 pb-5 border-b border-slate-100/80">
                <h2 className="text-[15px] font-bold text-slate-900 tracking-tight">
                  Source Documents
                </h2>
                <p className="text-[13px] text-slate-500 mt-1 leading-relaxed">
                  Upload new files from your system or browse already-uploaded
                  files in Azure storage. All files are analyzed together to
                  generate the Training Outline.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2">
                <button
                  ...
                  className={cn(
                    "group relative flex items-center gap-4 px-7 py-5 text-left transition-all duration-200",
                    uploadMode === "system"
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={cn(
                          "w-full rounded-xl border px-4 py-3 text-[14px] text-slate-800 outline-none transition-all",
              ...
              {(errorFiles.length > 0 || generateTO.isError) && (
                <div className="border-t border-slate-100/80 px-7 py-4 space-y-2.5">
                  {errorFiles.length > 0 && (
                ...
                <div className="px-6 pt-5 pb-4 border-b border-slate-100/80">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 shadow-[0_2px_8px_0_rgb(16,185,129,0.3)]">
                      ...
                      <div>
                        ...
                        <p className="text-[12px] text-slate-500 mt-0.5">
                          Upload a pre-built TO document
                        </p>
                      </div>
                    </div>
                    {toProvided ? (
                      <span className="flex items-center gap-1 rounded-full bg-emerald-100 px-2.5 py-1 text-[10px] font-bold text-emerald-700 border border-emerald-200 shrink-0">
                        <CheckCircle2 size={9} />
                        Provided
                      </span>
                    ) : (
                      <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[10px] font-bold text-slate-500 uppercase tracking-wide border border-slate-200 shrink-0">
                        Optional
                      </span>
                    )}
                  </div>
                  <p className="text-[12px] text-slate-500 mt-3 leading-relaxed">
                    Upload your own Training Outline to bypass AI-generated
                    structure and directly control the course hierarchy.
                  </p>
                </div>
                ...
                <div className="px-6 pt-5 pb-4 border-b border-slate-100/80">
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2.5">
                      <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 shadow-[0_2px_8px_0_rgb(139,92,246,0.3)]">
                    ...
                    <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[10px] font-bold text-slate-500 uppercase tracking-wide border border-slate-200">
                      Optional
                    </span>
                  </div>
                  <p className="text-[12px] text-slate-500 mt-2 leading-relaxed">
                    Provide context to improve Training Outline quality. Leave
                    blank for fully automatic detection.
                  </p>
                </div>
                ...
                <div className="px-6 py-5 space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-[13px] text-slate-800 outline-none",
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className={cn(
                        "w-full resize-none rounded-xl border border-slate-200 bg-white px-4 py-3 text-[13px] text-slate-800 outline-none",
                        "placeholder:text-slate-400 focus:border-violet-400 focus:ring-2 focus:ring-violet-50 transition-all",
                      )}
                    />
                    {customToPrompt.trim() && (
